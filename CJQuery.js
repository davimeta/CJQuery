 ...
 * @param {Chrome_JQuery_MINI} parentQuery parent query result,allow undefined | 父级查询器,允许为空
 * @param {number} index query from parent item index, allow undefined | 从父级某个索引位置的子元素继续查询,允许为空
 */
function Chrome_JQuery_MINI(selectors, parentQuery, index) {
    var PUBLIC = this;
...
Chrome_JQuery_MINI.prototype = [];
/**
 * add array to this array | 用于将检索到的元素集合加入本集合
 * @param {Array} arr array of queried | 检索到的元素集合
 */
Chrome_JQuery_MINI.prototype.pushItemsOfArray = function (arr) {
 ...
 */
Chrome_JQuery_MINI.prototype.val = function (newValue) {
    var n = this.length;
    for (var i = 0; i < n; i++) {
 ...
 */
Chrome_JQuery_MINI.prototype.css = function (key, value) {
    var n = this.length;
    for (var i = 0; i < n; i++) {
 ...
 */
Chrome_JQuery_MINI.prototype.click = function () {
    var n = this.length;
    for (var i = 0; i < n; i++) {
        this[i].click();
    }
 ...
 * @return {Chrome_JQuery_MINI} return new array searched | 返回查找到的集合
 */
Chrome_JQuery_MINI.prototype.find = function (selectors) {
    return new Chrome_JQuery_MINI(selectors, this);
}
/**
 ...
 * @return {Chrome_JQuery_MINI} return new array searched | 返回新找到的集合
 */
Chrome_JQuery_MINI.prototype.findAt = function (index, selectors) {
    return new Chrome_JQuery_MINI(selectors, this, index);
}
/**
 ...
 */
Chrome_JQuery_MINI.prototype.each = function (callback) {
    var n = this.length;
 ...
 */
Chrome_JQuery_MINI.prototype.emptyWarn = function (warnText) {
    var n = this.length;
 ...
 * @return {Chrome_JQuery_MINI} elements
 */
Chrome_JQuery_MINI.$c = function (selectors) {
    return new Chrome_JQuery_MINI(selectors);
}
 ...
 * @return {Chrome_JQuery_MINI} elements
 */
if (undefined != window) window.$c = Chrome_JQuery_MINI.$c;
/**
 * search elements by css selectors | 查找与css查询器相匹配的元素集合
 * @param  {string} selectors css selectors | css查询器
 * @return {Chrome_JQuery_MINI} elements
 */
var $c = Chrome_JQuery_MINI.$c;